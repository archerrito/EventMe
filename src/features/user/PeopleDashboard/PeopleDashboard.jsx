...
//gives us user id to identify users particular subcollections
// of following and followers, get that info in our reducers
const query = ({auth}) => {
  return [
    {
      collection: 'users',
...
//map state from redux store to our props
//props contains auth, pass to query with props
//destructure auth in query
export default compose(connect(mapState), firestoreConnect(props => 
  query(props)))(PeopleDashboard);